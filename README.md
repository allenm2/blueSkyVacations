...
<!DOCTYPE html>
<!-- saved from url=(0123)https://blackboard.csp.edu/bbcswebdav/pid-704643-dt-content-rid-9393975_1/courses/20163035548/project/proposalTemplate.html -->
<html lang="en" class="gr__blackboard_csp_edu"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 
<!-- proposalTemplate.php - project proposal outline for client.
  Matthew Allen  -  allenm2@cps.edu
  Courtney Norlander  -  whitfiec@csp.edu
  Ken Anich  -  anichk@csp.edu
  Written:     07-03-2016
  Revised: MA 07-06-16 Changed several colors to match color scheme to serve as a sample for the client.
           KA 07-03-16 Added theme design notes.
	   CN 07-03-16 Added theme design notes.
  -->
 <title>Blue Sky Vacations</title>
 ...
 @import url(https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,900italic,900,700italic,700,600italic,600,400italic,300italic,300,200italic,200);
  ...
  /* hold all color boxes and text description */
  .colorRow {
  border:      1px #302c90 solid;
  height:      175px;
  margin:      0px auto;
  ...
  /* text description under each color box */
  .colorRow p {
  margin:      0px auto;
  width:       120px;
  ...
  /* each color box + text description */
  .colorAndDesc {
  float:       left;
  width:       120px;
  }
